  ...
  module Helpers
    ...
    module Reporting
      ...
      def send_run_report(run_results = nil)
        ...
        body = "No problems to report. db is #{db_location}, #{db_filesize} bytes. Last modified: #{File.exist?(db_location) ? File.stat(db_location).mtime : ''}"
      ...
      def track_company_processed
        ...
        puts "incremented, #{statsd_namespace}"
